...
def new_transaction():
    ...
    required = ['sender', 'recipient', 'cards']
    if not all(k in values for k in required):
        return 'Missing values', 400

    # Create a new Transaction
    index = blockchain.new_transaction(values['sender'], values['recipient'], values['cards'])
